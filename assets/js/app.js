...
function renderFooter(){
  ...
  const icInsta = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.2c3.2 0 3.6 0 4.9.07 1.17.05 1.8.25 2.23.42.56.22.96.48 1.38.9.42.42.68.82.9 1.38.17.42.37 1.06.42 2.23.06 1.27.07 1.65.07 4.85s0 3.58-.07 4.85c-.05 1.17-.25 1.8-.42 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.42.17-1.06.37-2.23.42-1.27.06-1.65.07-4.9.07s-3.63 0-4.9-.07c-1.17-.05-1.8-.25-2.23-.42a3.7 3.7 0 01-1.38-.9 3.7 3.7 0 01-.9-1.38c-.17-.42-.37-1.06-.42-2.23C2.2 15.58 2.2 15.2 2.2 12s0-3.58.07-4.85c.05-1.17.25-1.8.42-2.23.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.42-.17 1.06-.37 2.23-.42C8.4 2.2 8.8 2.2 12 2.2zm0 1.8c-3.14 0-3.5 0-4.75.07-.9.04-1.38.2-1.7.32-.43.17-.74.37-1.06.7-.32.31-.52.62-.7 1.05-.12.32-.28.8-.32 1.7C3.4 8.5 3.4 8.86 3.4 12s0 3.5.07 4.75c.04.9.2 1.38.32 1.7.17.43.37.74.7 1.06.31.32.62.52 1.05.7.32.12.8.28 1.7.32 1.26.07 1.62.07 4.76.07s3.5 0 4.75-.07c.9-.04 1.38-.2 1.7-.32.43-.17.74-.37 1.06-.7.32-.31.52-.62.7-1.05.12-.32.28-.8.32-1.7.07-1.26.07-1.62.07-4.76s0-3.5-.07-4.75c-.04-.9-.2-1.38-.32-1.7a2.86 2.86 0 00-.7-1.06 2.86 2.86 0 00-1.05-.7c-.32-.12-.8-.28-1.7-.32C15.5 4 15.14 4 12 4zm0 3.06A4.94 4.94 0 1112 17a4.94 4.94 0 010-9.88zm0 1.8a3.14 3.14 0 100 6.28 3.14 3.14 0 000-6.28zm5.15-3.2a1.15 1.15 0 110 2.3 1.15 1.15 0 010-2.3z"/></svg>`;
  el.innerHTML = `
      ...
      <div class="footer-top">
        <div class="footer-brand">
          ...
          <ul class="foot-contact">
            ...
            <li><span class="ic">${icClock}</span><span>Customer Service: 7 Days a Week, 8AM–Midnight EST</span></li>
          </ul>
